...
function m(e){const o=g.value;o!==""&&(e==="todo"?s(a,o):e==="complete"&&s(r,o))}function i(){document.querySelectorAll("#done").forEach(t=>{t.addEventListener("click",w)}),document.querySelectorAll("#delete").forEach(t=>{t.addEventListener("click",E)})}function w(){const e=this.parentNode.parentNode;e.parentNode!==r&&(r.appendChild(e),c(),i())}function E(){const e=this.parentNode.parentNode;e.parentNode.removeChild(e),c(),i()}function s(e,o){const t=document.createElement("li");t.innerHTML=o,t.append(S()),t.classList.add("flex"),e.append(t),c(),i()}function S(){const e=document.createElement("div");return e.classList.add("actions"),e.classList.add("flex"),e.innerHTML=h,e}function f(e){const o=e.childNodes;let t=[];return o.forEach(l=>{t.push(l.innerText)}),t=t.filter(function(l){return l!==void 0}),t}function c(){const e=f(a),o=f(r);p.todo=e,p.completed=o,localStorage.setItem("todoapp-general",JSON.stringify(p)),i()}function x(){const e=localStorage.getItem("todoapp-general");if(e===null)return;const o=JSON.parse(e);o.todo.forEach(t=>{s(a,t)}),o.completed.forEach(t=>{s(r,t)}),i()}x();
